            ...
            <div class="col-lg-8 col-md-12 col-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <canvas id="myChart" height="223" style="display: block; height: 179px; width: 296px;" width="370"
                            ...
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="assets/img/avatar/avatar-5.png" class="img-fluid"
                                        data-toggle="tooltip" title="" data-original-title="Alfa Zulkarnain">
                                    <div class="avatar-badge" title="" data-toggle="tooltip"
                                        data-original-title="Editor"><i class="fas fa-wrench"></i></div>
                                </div>
                            </div>
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="assets/img/avatar/avatar-4.png" class="img-fluid"
                                        data-toggle="tooltip" title="" data-original-title="Egi Ferdian">
                            ...
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="assets/img/avatar/avatar-1.png" class="img-fluid"
                                        data-toggle="tooltip" title="" data-original-title="Jaka Ramadhan">
                                    <div class="avatar-badge" title="" data-toggle="tooltip"
                            ...
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="assets/img/avatar/avatar-2.png" class="img-fluid"
                                        data-toggle="tooltip" title="" data-original-title="Ryan">
                                    <div class="avatar-badge" title="" data-toggle="tooltip" data-original-title="Admin">
                                        <i class="fas fa-cog"></i>
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress" data-height="3" style="height: 3px;">
                                <div class="progress-bar" role="progressbar" data-width="28%" aria-valuenow="25"
                                    aria-valuemin="0" aria-valuemax="100" style="width: 28%;"></div>
                            </div>
                        </div>
                ...
                <div class="card mt-sm-5 mt-md-0">
                    ...
                    <div class="card-body">
                        <div id="visitorMap"
                            style="position: relative; overflow: hidden; background-color: rgb(255, 255, 255);"><svg
                                width="295.6" height="210">
                                <g transform="scale(0.31115789473684213) translate(0, 62.44925575101484)">
                                    <path
                                        ...
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_id"
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_pg"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_mx"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ee"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_dz"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ma"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_mr"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ci"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ml"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_bf"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ng"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_tn"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ly"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_eg"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_td"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sd"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_et"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_so"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ye"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_cf"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_st"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gq"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ga"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_cg"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ao"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ug"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ke"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_tz"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_zm"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_mw"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_mz"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_zw"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_na"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_bw"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sz"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gl"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_au"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sb"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_vu"
                                        class="jqvmap-region"></path>
                                    <path d="M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_fj"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ph"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_cn"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M787.46,248.31l-3.54,2.7l-0.19,5.2l3.06,3.56l0.76-0.67L787.46,248.31L787.46,248.31z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_tw"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_jp"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ru"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_mg"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_km"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sc"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_mv"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_cv"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ht"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_fk"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_is"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_no"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_lk"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_cu"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_bs"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_jm"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ec"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ca"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gt"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_pa"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_co"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ve"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gy"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sr"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M302.13,321.8l5.85,3.65l-3.06,6.08l-1.11,1.4l-3.25-1.87l0.09-6.55L302.13,321.8L302.13,321.8z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gf"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_pe"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_bo"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_py"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_uy"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ar"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_cl"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_kp"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_kr"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_kz"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_tm"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_uz"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_tj"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_kg"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_af"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_pk"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_th"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_kh"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_la"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_az"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ir"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_tr"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sa"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sy"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_iq"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gb"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ie"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_se"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_fi"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M518.07,151.37l-6.85-1.11l0.15,3.83l6.35,3.88l2.6-0.76l-0.15-2.92L518.07,151.37L518.07,151.37z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_lv"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_lt"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_by"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_pl"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_it"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_fr"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_de"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_dk"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_sk"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_at"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_hu"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_si"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ua"
                                        class="jqvmap-region"></path>
                                    <path
                                        d="M520.75,187.71l3.1,4.77l-0.26,2.7l1.11,0.05l2.63-4.45l-3.16-3.92l-1.79-0.74L520.75,187.71L520.75,187.71z"
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_md"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_ro"
                                        class="jqvmap-region"></path>
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_rs"
                                        class="jqvmap-region"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="#f2f2f2" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-opacity="0.8" fill="#ddd" original="#ddd" id="jqvmap1_gr"
                                        class="jqvmap-region"></path>
                                </g>
                            </svg>
                            <div class="jqvmap-zoomin">+</div>
                            <div class="jqvmap-zoomout">−</div>
                            <div id="jqvmap1_id_pin" for="id" class="jqvmap-pin"
                                style="position: absolute; left: 238.845px; top: 117.333px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_my_pin" for="my" class="jqvmap-pin"
                                style="position: absolute; left: 231.001px; top: 110.834px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_th_pin" for="th" class="jqvmap-pin"
                                style="position: absolute; left: 222.621px; top: 101.467px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_sy_pin" for="sy" class="jqvmap-pin"
                                style="position: absolute; left: 166.608px; top: 82.1548px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_eg_pin" for="eg" class="jqvmap-pin"
                                style="position: absolute; left: 160.834px; top: 90.0023px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_ae_pin" for="ae" class="jqvmap-pin"
                                style="position: absolute; left: 180.942px; top: 91.9345px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_nz_pin" for="nz" class="jqvmap-pin"
                                style="position: absolute; left: 273.579px; top: 167.795px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_tl_pin" for="tl" class="jqvmap-pin"
                                style="position: absolute; left: 244.793px; top: 125.291px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_ng_pin" for="ng" class="jqvmap-pin"
                                style="position: absolute; left: 142.493px; top: 106.886px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_si_pin" for="si" class="jqvmap-pin"
                                style="position: absolute; left: 146.793px; top: 70.3915px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_pa_pin" for="pa" class="jqvmap-pin"
                                style="position: absolute; left: 64.931px; top: 106.869px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_au_pin" for="au" class="jqvmap-pin"
                                style="position: absolute; left: 247.198px; top: 148.214px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_ca_pin" for="ca" class="jqvmap-pin"
                                style="position: absolute; left: 67.3627px; top: 43.7284px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                            <div id="jqvmap1_tr_pin" for="tr" class="jqvmap-pin"
                                style="position: absolute; left: 163.314px; top: 77.9464px;">
                                <div class="jqvmap-circle"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="text-small text-muted">Serj Tankian <div class="bullet"></div> 4
                                        Min</div>
                                </div>
                            </li>
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="text-small text-muted">Ujang Maman <div class="bullet"></div> 8
                                        Min</div>
                                </div>
                            </li>
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="text-small text-muted">Farhan A Mujib <div class="bullet"></div>
                                        21 Min</div>
                                </div>
                            </li>
                        </ul>
                                        ...
                                        <div class="note-toolbar card-header">
                                            ...
                                            <div class="note-btn-group btn-group note-para">
                                                <div class="note-btn-group btn-group"><button type="button"
                                                        ...
                                                        data-toggle="dropdown" title="" data-original-title="Paragraph"><i
